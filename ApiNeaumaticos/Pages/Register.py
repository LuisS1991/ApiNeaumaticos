import reflex as rx
from ApiNeaumaticos.Auth import RegistrationState, routes
...
def create_login_form():
    ...
    return rx.form(
        rx.box(
            create_label(label_text="username"),
            create_input_with_icon(
                icon_tag="user",
                input_id="username",
                placeholder_text="Jose maria",
                input_type="text",
            ),
            margin_bottom="1.5rem",
        ),
        ...
        rx.box(
            create_label(label_text="confirm_password"),
            create_input_with_icon(
                icon_tag="lock",
...
@rx.page("/register", "Api")
def Register() -> rx.Component:
    """Render the complete signup page."""
