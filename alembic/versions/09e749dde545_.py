...
Revision ID: 09e749dde545
Revises: 
Create Date: 2024-10-17 09:35:09.470676
...
def upgrade() -> None:
    ...
    op.create_table('tokenapi',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('token', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('userId', sa.Integer(), nullable=False),
    sa.Column('apiName', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
